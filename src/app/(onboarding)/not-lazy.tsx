...
const content = {
  headline: 'You’re not lazy. You’re being played.',
  subHeadline: 'These apps are designed to hijack your attention and keep you scrolling. We’re here to help you fight back.',
  skipLink: 'Skip',
  buttonText: 'Take Back Control',
};
...
const MainContent = () => (
  <View style={styles.contentContainer}>
    ...
    <Image
      source={require('@/assets/images/mascot-distraction.png')} // Image updated
...
const NotLazyScreen = () => {
  ...
  const handleNextPress = () => {
    ...
    router.push('/(onboarding)/distractions' as any); 
  };
