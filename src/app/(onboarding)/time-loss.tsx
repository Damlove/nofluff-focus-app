...
const content = {
headline: 'The average person loses 3+ hours a day to distractions.',
subHeadline: 'That’s 1,095 hours / 45 days a year.',
skipLink: 'Skip',
buttonText: 'See The Damage',
};
...
<Image
source={require('@/assets/images/mascot-timeloss.png')} // Image updated
...
router.push('/(onboarding)/averagetimeloss' as any);
};
return (
