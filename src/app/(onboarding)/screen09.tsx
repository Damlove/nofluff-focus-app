...
// --- Centralized Content ---
const content = {
  headline: 'You set a focus session',
  subHeadline: 'Pick your work window. We lock you in, That’s it.',
  skipLink: 'Skip',
  buttonText: 'Continue',
...
const MainContent = () => (
  <View style={styles.contentContainer}>
    ...
    <Image
      source={require('@/assets/images/screen09-new.png')}
...
const SetFocusSessionScreen = () => {
  ...
  const handleNextPress = () => {
    router.push('/(onboarding)/screen10' as any); // Updated navigation path
  };
  return (
...
const styles = StyleSheet.create({
  ...
  headline: { color: '#F8FFDA', fontSize: 42, fontFamily: 'HelveticaNowDisplay-Bold', textAlign: 'center', width: 300, lineHeight: 45, marginBottom: 0, letterSpacing: 0.5, },
  subHeadline: { color: '#CFCFCF', fontSize: 18, fontFamily: 'HelveticaNowDisplay-Regular', textAlign: 'center', width: 200, lineHeight: 24, },
  illustrationImage: { width: 386, height: 358, alignItems: 'center', },
