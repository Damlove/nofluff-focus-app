...
const content = {
headline: 'That’s why we built NOFLUFF.',
subHeadline: 'The system that locks distractions and forces you to confront your excuses.',
skipLink: 'Skip',
...
<Image
source={require('@/assets/images/screen07.png')} // Image updated
...
router.push('/(onboarding)/screen08' as any);
};
return (
